...
/**
 * Heart Talk Book Website Generator - Kannada Edition
 *
 * This script parses "Heart Talk - Kannada.md" and generates a beautiful
 ...
 * 7. Create index-kn.html with full TOC navigation
 */
...
const markdownContent = fs.readFileSync('Heart Talk - Kannada.md', 'utf-8');
...
if (!fs.existsSync('chapters-kn')) {
  fs.mkdirSync('chapters-kn');
}
...
<body>
    <div class="book-container">
        ...
        <div class="chapter-actions">
            ...
            <a href="https://raw.githubusercontent.com/rkrules/heart-talks/main/pdfs/chapter${index + 1}.pdf" class="pdf-download" download>
                📥 Download PDF
            </a>
        </div>
        ...
        <footer class="book-footer">
            <p>
                <a href="../index-kn.html">← Table of Contents</a> ·
  ...
  fs.writeFileSync(`chapters-kn/chapter${index + 1}.html`, html);
  console.log(`Generated chapter${index + 1}.html - Heart Talk #${chapter.number}: ${chapter.title}`);
});

// Generate index-kn.html with normalized titles
    ...
    <div class="book-container">
        ...
        <main class="table-of-contents">
            ...
            <div class="toc-grid">
                ...
                <a href="chapters-kn/chapter${index + 1}.html" class="toc-item">
        ...
        <section class="download-section">
            ...
            <div class="download-grid">
                <div class="download-card">
                    ...
                    <a href="https://raw.githubusercontent.com/rkrules/heart-talks/main/pdfs/heart-talk-complete.pdf" class="download-btn" download>
...
fs.writeFileSync('index-kn.html', indexHTML);
console.log('Generated index-kn.html');
